...
interface EditFoundReportPageProps {
...
const EditFoundReportPage = ({ params }: EditFoundReportPageProps) => {
        ...
        if (response.success && response.result) {
          ...
          if (pet && pet.report_type?.toString() === "2") {
            ...
            const mappedData: EditReportPetParams = {
              ...
              date_found: initialDate ? formatDateToMMDDYYYY(new Date(initialDate)) : "",
            ...
            console.log("Mapped petData (Found):", mappedData);
            setPetData(mappedData);
            setSelectedDate(initialDate ? new Date(initialDate) : null);
            setBreeds(breedData);
          } else {
            throw new Error("Report is not a Found report or not found");
          }
        }
      } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!petData.where_pet_was_found) {
      toast.error("Please enter where the pet was found.");
      return;
    }

    if (!petData.condition) {
    ...
    const updatedPetData: EditReportPetParams = {
      ...petData,
      date_found: formatDateToMMDDYYYY(selectedDate),
      date_lost: undefined, // Ensure Lost fields are not sent
      nearest_address_last_seen: undefined,
    };
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Report Type: <span className="font-medium">Found</span></p>
            </div>
          </div>
        </div>
          ...
          <div className="p-6 border-b border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">
                  Currently: {conditionMap[petData.condition || ""] || "Unknown"}
                </p>
              </div>
...
export default EditFoundReportPage;